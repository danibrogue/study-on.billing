...
/**
 * @extends ServiceEntityRepository<BillingUser>
 *
 ...
 */
class BillingUserRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
    ...
    public function add(BillingUser $entity, bool $flush = false): void
    {
    ...
    public function remove(BillingUser $entity, bool $flush = false): void
    {
